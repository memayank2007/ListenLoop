...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { employer_id: @presentation.employer_id, publish: @presentation.publish, title: @presentation.title }
    end
  ...
  test "should update presentation" do
    patch :update, id: @presentation, presentation: { employer_id: @presentation.employer_id, publish: @presentation.publish, title: @presentation.title }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
